...
def test_module_create_message_polymorphism():
    ...
    mod_vmb4ryld20 = Module(0x01, 0x26)
...
def test_channel_create_message_delegation():
    ...
    mod = Module(0x05, 0x26)
    channel = Channel(mod, 1, "Relay", False, False, AsyncMock(), 0x05)
